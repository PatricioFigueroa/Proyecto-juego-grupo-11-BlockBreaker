...
public class PingBall {
	    ...
	    private boolean collidesWithborde(Paddle pp) {
	    	boolean bordesIqz = (pp.getX() + pp.getWidth() == x-size) && (pp.getY() + pp.getHeight() >= y-size) && (pp.getY() <= y+size) ;
	    	boolean bordesDer= (pp.getX() == x+size) && (pp.getY() + pp.getHeight() >= y-size) && (pp.getY() <= y+size);
	    	return bordesIqz || bordesDer;
	    }
